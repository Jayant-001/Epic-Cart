...
const Footer = () => {
    const footerNavs = [
        {
            href: "https://jayant-kiet.netlify.app",
            name: "Portfolio",
        },
        {
        ...
        {
            href: "/https://leetcode.com/jayant2k1/",
            name: "Leetcode",
        },
        {
            href: "https://codeforces.com/profile/Jayant001",
            name: "Codeforcs",
        },
    ];

    return (
        <footer className="text-gray-500 bg-white px-4 py-5 w-full shadow border-t mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                ...
                <p className="leading-relaxed mt-2 text-[15px]">
                    Designed and Developed by JAYANT
                </p>
            </div>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2023 Jayant All rights reserved.
                </div>
